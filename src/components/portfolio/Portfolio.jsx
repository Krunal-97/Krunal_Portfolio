...
const Portfolio = () => {
  return (
    <div id="portfolio" className="portfolio__container sec__container">
      <div className="project">
        ...
        <div className="project__btns">
          <a className="btn" href="http://tickr-ims.herokuapp.com/home">
            Visit Project
          </a>
      ...
      <div className="project">
        ...
        <p></p>
        <div className="project__btns">
          <a className="btn" href="https://myproject-10599.firebaseapp.com/">
            Visit Project
          </a>
          <a
            className="btn"
      ...
      <div className="project">
        ...
        <p className="project__description">
          • Implemented APIs with Python and Chalice, and fetched it with axios
          in the React. Aftet that, stored card information to the database.
        </p>
        <p className="project__description">
      ...
      <div className="project">
        ...
        <p className="project__description">
          ...
          subpages of child pages container, custom footer widget areas options,
